...
const ExpenseListItem = (props) => {
  ...
  return (
    <Card>
      <div>
        <div className="" style={{ display: 'flex', justifyContent: 'space-between', fontWeight: 'bold', fontSize: 16 }}>{itemDetail.category.name}<div className="color-title">{itemDetail.amount} ₹.</div></div>
